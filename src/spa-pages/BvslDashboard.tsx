...
import { Users, CheckSquare, BarChart3, BookOpen, FileText, Brain, GraduationCap, CalendarClock, ClipboardList } from 'lucide-react';
import { Button } from '@/components/ui/button';
import { toast } from 'sonner';
import { getBvslGroups } from 'zite-endpoints-sdk';
...
export default function BvslDashboard() {
  ...
  const tabs: TabConfig[] = [
    ...
    { value: 'onetone',   label: '1:1',         icon: CalendarClock },
  ];

  const subtitle = [
    'Bhakti Vriksha Servant Leader',
