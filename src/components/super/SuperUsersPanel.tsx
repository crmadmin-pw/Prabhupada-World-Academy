...
import { getGuideUsers, getGuides, tagUserAsBvsl, assignGuide, tagUserAsFolkLead, tagUserAsTripCoordinator, tagUserAsBvMentor, tagUserAsSadhanaMentor } from 'zite-endpoints-sdk';
...
export default function SuperUsersPanel() {
  ...
  }, [users, guideFilter, ashrayFilter, residentFilter, search, sortKey, sortDir]);
          ...
          <div className="flex flex-col gap-3">
            <div className="flex flex-wrap gap-3 items-end">
              ...
              <Select value={guideFilter} onValueChange={(v) => setGuideFilter(v || 'all')}>
                <SelectTrigger className="h-9 w-44 shrink-0"><SelectValue placeholder="All Guides" /></SelectTrigger>
                <SelectContent>
            ...
            <table className="w-full text-sm">
              <thead className="sticky top-0 z-10">
                <tr className="border-b">
                  ...
                  <th className="text-left px-3 py-2 font-medium text-xs bg-muted">Assign Guide</th>
                  ...
                  return (
                    <tr key={u.userId} className="border-b hover:bg-accent/40 cursor-pointer"
                      ...
                      <td className="px-3 py-2 font-medium">
                        {u.fullName}
                        {(u.isBvsl || u.role === 'BVSL') && <Badge className="ml-1 text-xs bg-purple-500">BVSL</Badge>}
                      </td>
